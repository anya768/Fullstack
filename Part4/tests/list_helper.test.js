...
describe('total likes', () => {
  ...
  test('when list is has one item, ', () => {
    const result = listHelper.totalLikes([])
    expect(result).toBe(0)
  })
...
describe('favorite blog', () => {
  test('when list of blogs are given, it returns blog with max likes', () => {
...
describe('most blogs', () => {
  test('when list of blogs are given, it returns author with most blogs', () => {
    expect(listHelper.mostBlogs(blogs)).toEqual({ author:'Robert C. Martin', blogs: 3 })
  })
})

describe('most likes', () => {
  test('when list of blogs are given, it returns author with most likes', () => {
